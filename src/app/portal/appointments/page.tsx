...
function PortalAppointmentMobileCard({ row }: { row: AppointmentRow }) {
  return (
    <DataRecordCard
      title={row.title}
...
export default async function PortalAppointmentsPage() {
  ...
  return (
    ...
    >
      <DataTable columns={columns} rows={appointments} empty="لا توجد مواعيد مرتبطة بحسابك حتى الآن." mobileRender={(row) => <PortalAppointmentMobileCard row={row} />} />
    </DashboardShell>
  );
}
