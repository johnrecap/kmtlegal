...
export default async function PortalCaseDetailPage({ params }: PageProps) {
  const guard = await requirePortalPage(`/portal/cases/${params.caseId}`);
          ...
          <CardHeader>
            <div className="flex flex-wrap items-start justify-between gap-3">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Badge tone={legalCase.priority === "URGENT" || legalCase.priority === "HIGH" ? "pending" : "neutral"}>
                  {labelFrom(priorityLabels, legalCase.priority)}
                </Badge>
              </div>
            </div>
          </CardHeader>
          ...
          <Card>
            ...
            <CardContent>
              {legalCase.sessions.length ? (
                ...
                <StateBlock title="لا توجد جلسات مسجلة" description="تحديثات الجلسات ستظهر هنا عندما يضيفها المكتب." />
              )}
            </CardContent>
          </Card>
