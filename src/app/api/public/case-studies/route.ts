...
export async function GET(request: Request) {
  ...
  // Owner decision (launch fixes TASK 02): case studies are not publicly readable.
  // Closed at the route boundary before any content service or database read.
  return jsonError(404, "NOT_FOUND", "Case studies are not publicly available.", undefined, undefined, { locale });
}
