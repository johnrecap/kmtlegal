...
import { listAdminPaymentWebhookEvents } from "@/server/payments/payment-service";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return errorToResponse(error, requestId, { routeGroup: "admin-payment-webhooks", method: "GET" });
  }
}
