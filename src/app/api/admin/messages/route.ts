...
import { listAdminConversations } from "@/server/conversations/conversation-service";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return errorToResponse(error, requestId, { routeGroup: "admin.messages", method: "GET" });
  }
}
