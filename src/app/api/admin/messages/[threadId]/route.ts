...
export async function GET(request: Request, { params }: AdminMessageRouteProps) {
  ...
  try {
    ...
    return errorToResponse(error, requestId, { routeGroup: "admin.messages.detail", method: "GET" });
  }
}
...
export async function PATCH(request: Request, { params }: AdminMessageRouteProps) {
  ...
  try {
    ...
    return errorToResponse(error, requestId, { routeGroup: "admin.messages.detail", method: "PATCH" });
  }
}
