...
import { listAdminContactMessages } from "@/server/admin/contact-message-service";
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return errorToResponse(error, requestId, { routeGroup: "admin.contact-messages", method: "GET" });
  }
}
