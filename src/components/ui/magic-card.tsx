...
export function MagicCard(props: MagicCardProps) {
  ...
  return (
    <motion.div
      ...
      style={{
        // KMT port: upstream var(--color-background)/var(--color-border)
        // (Tailwind v4 theme tokens) mapped to the public surface scale.
        background: useMotionTemplate`
          linear-gradient(var(--kmt-public-panel) 0 0) padding-box,
          radial-gradient(${gradientSize}px circle at ${mouseX}px ${mouseY}px,
            ${gradientFrom},
            ${gradientTo},
            var(--kmt-public-line) 100%
          ) border-box
        `,
      }}
    >
      <div className="absolute inset-px z-20 rounded-[inherit] bg-[var(--kmt-public-panel)]" />
