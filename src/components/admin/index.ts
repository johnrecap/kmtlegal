/**
 * Admin UI kit — single home (Phase 09). Phases 10–11 consume ONLY these
 * primitives + the documented conventions (see CONVENTIONS.md). No per-page
 * duplication, no new one-off overlays.
 */
