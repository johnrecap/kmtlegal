...
// NOTE (KMT): `ref` is omitted from the props type because the upstream
// React 19 `LegacyRef` typing is incompatible with this project's React 18
// types when spread into `Slot`. Ref forwarding is not used by our callers.
