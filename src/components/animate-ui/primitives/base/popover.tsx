/**
 * Animate UI Base Popover primitive (official source:
 * https://animate-ui.com/r/primitives-base-popover.json, fetched 2026-09-19
 * for Phase 09). OWNER-APPROVED ANIMATE UI DEPENDENCY-NAMESPACE ADAPTATION
 * — body otherwise byte-identical:
 * - `@base-ui-components/react/popover` → `@base-ui/react/popover`
 *   (Base UI renamed the package namespace; `@base-ui/react@1.8.0` is
 *   installed).
