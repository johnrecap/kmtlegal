...
export const publicContentAr = {
  ...
  bookingPage: {
    ...
    metadataDescription: "نموذج حجز استشارة قانونية منظم مع مراجعة بشرية ومساعد AI داخلي.",
    heroEyebrow: "طلب استشارة",
    heroTitle: "اكتب طلبك في خطوات قليلة",
    heroDescription: "النموذج يرتب بياناتك للمراجعة البشرية، ولا يقدم استشارة قانونية نهائية قبل تواصل الفريق.",
    sectionEyebrow: "طلب استشارة",
    sectionTitle: "اكتب طلبك في خطوات قليلة",
    sectionDescription: "النموذج يحفظ البيانات بشكل منظم، ويستخدم مساعدا داخليا لترتيب الطلب للمراجعة البشرية. لا ترسل مستندات في هذه المرحلة.",
