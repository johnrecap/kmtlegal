...
export const publicContentAr = {
  ...
  bookingPage: {
    ...
    manualHeroDescription: "املأ نموذج الطلب المختصر، ثم يراجع المكتب البيانات ويتواصل معك لتحديد الخطوة المناسبة.",
    ...
    manualSectionTitle: "أرسل طلبك للمراجعة المكتبية",
    manualSectionDescription: "لا توجد رسوم حجز في هذا الوضع، ولا يتم تأكيد موعد تلقائيًا. يراجع المكتب الطلب ثم يتواصل معك.",
