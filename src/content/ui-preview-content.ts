...
export const uiPreviewCopy = {
  en: {
    ...
    booking: { eyebrow: "Consultation request", title: "Make the first request clear.", lead: "This interactive preview uses sample availability only. Nothing is sent to KMT Legal.", summary: "Request summary", edit: "Edit", openSummary: "Review request", close: "Close", service: "Matter area", method: "Meeting preference", details: "Brief context", detailsHint: "Share the main fact, date, or requested action. Do not add documents or sensitive data.", slot: "Sample appointment window", chooseSlot: "Choose a sample time", confirm: "Confirm demo request", conflict: "Simulate unavailable time", simulateError: "Simulate temporary error", retry: "Try again", confirmed: "Demo request ready for review", confirmation: "This is a simulated result. No request, appointment, payment, or reference has been created.", conflictMessage: "That sample time is no longer available in this preview. Choose another visible time.", temporaryError: "The demo could not complete this time. Your answers are still here; try again when ready.", notChosen: "Not chosen", empty: "Choose a matter area and a sample time to review the request.", online: "Online", phone: "Phone", office: "Office visit", sample: "Sample data", noNetwork: "No booking, payment, or provider request is made from this preview." },
  ...
  ar: {
    ...
    booking: { eyebrow: "طلب استشارة", title: "اجعل الطلب الأول واضحًا.", lead: "تستخدم هذه المعاينة مواعيد نموذجية فقط. لا يتم إرسال أي شيء إلى KMT Legal.", summary: "ملخص الطلب", edit: "تعديل", openSummary: "مراجعة الطلب", close: "إغلاق", service: "مجال المسألة", method: "طريقة الاجتماع", details: "سياق مختصر", detailsHint: "اكتب الواقعة الأساسية أو التاريخ أو الإجراء المطلوب. لا تضف مستندات أو بيانات حساسة.", slot: "نافذة موعد نموذجية", chooseSlot: "اختر وقتًا نموذجيًا", confirm: "تأكيد الطلب التجريبي", conflict: "محاكاة عدم توفر الوقت", simulateError: "محاكاة خطأ مؤقت", retry: "حاول مرة أخرى", confirmed: "الطلب التجريبي جاهز للمراجعة", confirmation: "هذه نتيجة تجريبية. لم يُنشأ طلب أو موعد أو دفع أو رقم مرجعي.", conflictMessage: "هذا الوقت النموذجي لم يعد متاحًا داخل المعاينة. اختر وقتًا ظاهرًا آخر.", temporaryError: "تعذر إكمال التجربة هذه المرة. إجاباتك ما زالت محفوظة؛ حاول مرة أخرى عندما تكون جاهزًا.", notChosen: "لم يُختر", empty: "اختر مجال المسألة ووقتًا نموذجيًا لمراجعة الطلب.", online: "عبر الإنترنت", phone: "هاتف", office: "زيارة المكتب", sample: "بيانات نموذجية", noNetwork: "لا تُرسل هذه المعاينة طلب حجز أو دفع أو مزود خدمة." },
