...
2026-09-12 Batch 9 checkpoint: case-tab document upload retains an authorized current case outside the 100-option list; document soft deletion is now confirmed through its dedicated POST route, while ordinary PATCH cannot revive a deleted document. Isolated browser/PostgreSQL evidence plus full typecheck, lint, build and 523-test sequential suite evidence are in `docs/reviews/2026-09-12/batch9/BATCH-9.md`; the remaining role/visual/concurrency matrix is explicit there.
