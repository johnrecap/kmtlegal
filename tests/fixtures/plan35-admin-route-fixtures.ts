...
export const FINAL_PLAN35_ADMIN_ROUTE_MATRIX: readonly Plan35AdminRouteFixture[] = [
  ...
  { id: "contacts.list", href: "/admin/contact-messages", apiProbe: "/api/admin/contact-messages", state: "planned", defaultAccess: access(false, true, true, false) },
  { id: "notifications.list", href: "/admin/notifications", apiProbe: "/api/admin/notifications", state: "planned", defaultAccess: access(true, true, true, true) },
