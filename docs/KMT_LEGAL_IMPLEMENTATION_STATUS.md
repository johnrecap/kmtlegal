...
2026-09-12 Batch 9 checkpoint: document case-tab uploads retain a current case omitted by the capped option list; PATCH excludes `DELETED`, and document update/delete writes are guarded against soft-delete races. Isolated PostgreSQL/browser plus typecheck, lint, build and full-suite evidence is recorded in `docs/reviews/2026-09-12/batch9/BATCH-9.md`; broader role/visual/concurrency verification remains open.
