...
- A repeated receipt number for the same client is rejected to reduce accidental double-recording.
...
5. If the client paid by Instapay or bank transfer, create a manual finance payment with the real receipt/reference. Do not label it as PayTabs or Paymob.
6. If there is any doubt, keep the consultation in manual review and contact the client from the office channel.
