...
async function seedPublicData(users) {
  await prisma.lawyerProfile.upsert({
    ...
    create: {
      ...
      bio: "ملف تجريبي لمحامية داخل KMT Legal مع خبرة في العقود التجارية وحوكمة الشركات.",
  ...
  const services = [
    {
      ...
      category: "corporate",
      description: "صياغة ومراجعة العقود التجارية مع توضيح المخاطر والالتزامات الأساسية.",
      content: "خدمة تجريبية لصياغة العقود ومراجعة البنود الحرجة قبل التوقيع، بدون تقديم وعود بنتيجة قانونية.",
      requiredDocuments: ["السجل التجاري", "مسودة العقد", "بيانات الأطراف"]
    },
    {
      title: "الاستشارات العقارية",
      slug: "real-estate-consultation",
      category: "real-estate",
      description: "استشارات قانونية للملكية والتصرفات العقارية ومراجعة المستندات.",
      content: "خدمة تجريبية لمراجعة مستندات الملكية والتصرفات العقارية وتحديد نقاط الفحص المطلوبة.",
      requiredDocuments: ["مستند الملكية", "بطاقة الهوية", "أي عقود سابقة"]
    },
    {
      title: "التحصيل التجاري",
      slug: "commercial-collection",
      category: "commercial",
      description: "متابعة مطالبات مالية وتجارية وفق مسار قانوني منظم.",
      content: "خدمة تجريبية لتنظيم المطالبة بالمستحقات التجارية ومراجعة المستندات المؤيدة.",
      requiredDocuments: ["الفواتير", "أوامر التوريد", "المراسلات"]
    }
  ];
  ...
  await prisma.article.upsert({
    ...
    create: {
      ...
      excerpt: "مقال تجريبي عن مراجعة البنود الحرجة قبل توقيع العقود التجارية.",
      content: "محتوى تجريبي عام لا يمثل نصيحة قانونية. يجب مراجعة محام قبل اتخاذ أي قرار.",
